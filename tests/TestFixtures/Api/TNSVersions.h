...
@interface TNSInterfaceAlwaysAvailable(AvailableAfter1_0)

- (void)availableStaticMethod1_0;

- (void)explicitlyUnvailableStaticMethod __attribute__((availability(ios, introduced = MAX_AVAILABILITY)));

+ (void)availableMethod1_0;

- (void)explicitlyUnvailableMethod __attribute__((availability(ios, introduced = MAX_AVAILABILITY)));

@end

__attribute__((availability(ios, introduced = MAX_AVAILABILITY)))
@interface TNSInterfaceAlwaysAvailable(NeverAvailable)

- (void)unavailableStaticMethod;

- (void)explicitlyAvailableStaticMethod1_0 __attribute__((availability(ios, introduced = 1.0)));

+ (void)unavailableMethod;

- (void)explicitlyAvailableMethod1_0 __attribute__((availability(ios, introduced = 1.0)));
