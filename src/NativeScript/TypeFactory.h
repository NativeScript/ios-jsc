...
private:
    ...
    ObjCBlockType* parseBlockType(GlobalObject*, Metadata::TypeEncodingsList<uint8_t>& typeEncodings);

    JSC::JSCell* parseFunctionReferenceType(GlobalObject* globalObject, Metadata::TypeEncodingsList<uint8_t>& typeEncodings);

    RecordConstructor* getAnonymousStructConstructor(GlobalObject*, Metadata::TypeEncodingDetails::AnonymousRecordDetails& details);
